...
public sealed class DeckMutationTools
{
    ...
    [McpServerTool(Name = "add_card", ReadOnly = false, Destructive = false, Idempotent = false, OpenWorld = true)]
    ...
    [McpServerTool(Name = "remove_card", ReadOnly = false, Destructive = true, Idempotent = false, OpenWorld = true)]
    ...
    [McpServerTool(Name = "set_card_quantity", ReadOnly = false, Destructive = true, Idempotent = true, OpenWorld = true)]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return decks.SetCardQuantityAsync(workspaceId, cardName, quantity, category, cancellationToken);
    }

    [McpServerTool(Name = "move_card", ReadOnly = false, Destructive = true, Idempotent = true, OpenWorld = true)]
    [Description("Move a card to another primary category, such as Mainboard, Sideboard, or Maybeboard.")]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return decks.MoveCardAsync(workspaceId, cardName, toCategory, fromCategory, cancellationToken);
    }

    [McpServerTool(Name = "update_deck_metadata", ReadOnly = false, Destructive = true, Idempotent = true, OpenWorld = true)]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return decks.UpdateDeckMetadataAsync(workspaceId, name, format, description, cancellationToken);
    }
}
