...
public static class MtgMcpConfigurationAliases
{
    ...
    [
        ...
        ("REDDIT:CLIENT_ID", "MtgMcp:Reddit:ClientId"),
        ("REDDIT:CLIENT_SECRET", "MtgMcp:Reddit:ClientSecret"),
        ("REDDIT:REFRESH_TOKEN", "MtgMcp:Reddit:RefreshToken"),
        ("REDDIT:ACCESS_TOKEN", "MtgMcp:Reddit:AccessToken"),
        ("REDDIT:BEARER_TOKEN", "MtgMcp:Reddit:BearerToken"),
        ("REDDIT:EXPIRES_AT_UTC", "MtgMcp:Reddit:ExpiresAtUtc"),
        ("REDDIT:USER_AGENT", "MtgMcp:Reddit:UserAgent"),
        ("REDDIT:SCOPE", "MtgMcp:Reddit:Scope"),
        ("REDDIT:DEVICE_ID", "MtgMcp:Reddit:DeviceId"),
        ("REDDIT:CREDENTIALS_FILE", "MtgMcp:Reddit:CredentialsFile"),
        ("REDDIT:OAUTH_BASE_ADDRESS", "MtgMcp:Reddit:OAuthBaseAddress"),
        ("REDDIT:TOKEN_ENDPOINT", "MtgMcp:Reddit:TokenEndpoint"),
