...
public static class DeckTaggerTaxonomy
{
    ...
    [
        ...
        Rule("repeatable-artifact-tokens", DeckRoles.Synergy, DeckTags.Tokens, 84),
        ...
        Rule("repeatable-food", DeckRoles.Synergy, DeckTags.Lifegain, 66),
        Rule("synergy-food", DeckRoles.Synergy, DeckTags.Lifegain, 66),
