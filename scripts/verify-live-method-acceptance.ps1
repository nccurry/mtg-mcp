...
if ($records.Count -ne 93 -or $live.Count -ne 91 -or $fixtureOnly.Count -ne 2 -or $incomplete.Count -ne 0) {
    $summary = $records |
        Group-Object status |
        Sort-Object Name |
...
Write-Host "Live method acceptance complete: resource=1, live-pass=91, fixture-only=2."
