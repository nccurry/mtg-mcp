...
| 2 | Freeze public surface, package metadata, and documentation. | CUT-003 through CUT-005, CUT-013, CUT-016 | Three mode snapshots, forbidden scans, docs review, and preview version checks pass. |
...
- Update the child matrix, cutover crosswalk/totals, and schema snapshots in
  one reviewed change whenever a public tool changes.
