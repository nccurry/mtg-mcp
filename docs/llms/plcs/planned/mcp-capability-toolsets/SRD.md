...
- [ ] All current tools have one tested assignment.
- [ ] Default/all/none and explicit lists pass in all modes.
- [ ] Capability schema and documentation match runtime behavior.
- [ ] No dynamic surface or generic router enters the stable design.
