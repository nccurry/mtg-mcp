...
| 8 | Reconcile the Playgroup public API. | PROG-002 through PROG-024 | `playgroup-public-api` | Pinned official surface, write safety, `playgroup` assignment, and north-star acceptance are decision-complete. | Reconciled; independent child review pending |
